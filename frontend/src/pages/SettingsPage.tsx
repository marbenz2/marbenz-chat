...
const PREVIEW_MESSAGES = [
  { id: 1, content: "Hey! Wie gehts dir?", isSent: false },
  {
    id: 2,
    content: "Mir geht's super! Ich arbeite hart an weiteren Features.",
    isSent: true,
  },
];
    ...
    <div className="min-h-screen container mx-auto px-4 pt-20 max-w-5xl">
      <div className="space-y-6">
        <div className="flex flex-col gap-1">
          <h2 className="text-lg font-semibold">Aussehen</h2>
          <p className="text-sm text-base-content/70">
            Wähle ein Thema für die Benutzeroberfläche
          </p>
        </div>
